...
@section('content')
    <div class="content container-fluid viewproduct_page">
        <div class="page-header">
            <div class="row">
                <div class="col">
                    <h3 class="page-title">View Vehcile Details</h3>
                </div>
            ...
            <!-- <div class="row">
                <div class="col">
                    ...
                    <a href="{{ route('admin.viewcustomervehicles')}}" class="btn btn-primary active">Vehicles</a>
...
<script>
	$(document).ready(function() {
		var table = $('#vehiclesList').DataTable({
			...
			serverSide: true,
			ajax: {
                url: '{{ route("admin.get_customervehicleListing", ["id" => $id]) }}',
				// url: '{{ Route('admin.get_customervehicleListing') }}',
				data: function(d) {
