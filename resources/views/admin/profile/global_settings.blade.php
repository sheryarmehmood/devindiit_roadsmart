                     ...
                     <div class="col">
                         <div class="col-xl-6">
                           <div class="form-group row">
                              <label class="col-lg-12 col-form-label">Mail_from_Address</label>
                              <div class="col-lg-12">
                        ...
                        <div class="col-xl-6">
                           <div class="form-group row">
                              <label class="col-lg-12 col-form-label">Mail_from_Name</label>
                              <div class="col-lg-12">
                         ...
                         <div class="col-xl-6">
                           <div class="form-group row">
                              <label class="col-lg-12 col-form-label">Mail_Host</label>
                              <div class="col-lg-12">
                                 <input type="text" class="form-control"  id="" name="">
                              </div>
                           </div>
                        ...
                        <div class="col-xl-6">
                           <div class="form-group row">
                              <label class="col-lg-12 col-form-label">Mail_Port</label>
                              <div class="col-lg-12">
                                 <input type="text" class="form-control"  id="" name="">
                              </div>
                           </div>
                        ...
                        <div class="col-xl-6">
                           <div class="form-group row">
                              <label class="col-lg-12 col-form-label">Mail_Username</label>
                              <div class="col-lg-12">
                                 <input type="text" class="form-control"  id="" name="">
                              </div>
                           </div>
                        ...
                        <div class="col-xl-6">
                           <div class="form-group row">
                              <label class="col-lg-12 col-form-label">Mail_Password</label>
                              <div class="col-lg-12">
                                 <input type="text" class="form-control"  id="" name="">
                              </div>
                           </div>
                        ...
                        <div class="col-xl-6">
                           <div class="form-group row">
                              <label class="col-lg-12 col-form-label">Mail_Encryption</label>
                              <div class="col-lg-12">
                                 <input type="text" class="form-control"  id="" name="">
                              </div>
                           </div>
