   ...
   <div class="content container-fluid add-product-page">
      ...
      <div class="row">
         <div class="col-md-12">
                        ...
                        <div class="col-xl-12">
                            <div class="form-group">
                              <label class="col-form-label">Product Name</label>
                               <input type="text" id="" class="form-control" name="" value="Mud flaps, front set">
                           </div>
                        </div>
						<div class="col-lg-12 ">
							<div class="form-group">
							    ...
							    <select name="status" id="status" class="my-select form-control">
                                    ...
                                    <option value="Parts ">Road Compliance</option>
                                    <option value="Accessories "> Insurance </option>
                                </select>
							</div>
						</div>
						<div class="col-xl-12">
                            <div class="form-group">
                              <label class="col-form-label">Make</label>
                               <input type="text" id="" class="form-control" name="" value="BMW">
                           </div>
                        </div>
                        <div class="col-md-12">
								<div class="form-group">
								  <label class="col-form-label">Vendor   </label>
							     <input type="text" id="" class="form-control" name="" value="Britanney Jacobson">
							    </div>
						</div>
                        <div class="col-xl-12">
                            <div class="form-group">
                              <label class="col-form-label">Brand Name</label>
                               <input type="text" id="" class="form-control" name="" value="Marvin Daniels">
                           </div>
                        </div>
						<div class="col-xl-12">
                            <div class="form-group">
                              <label class="col-form-label">Description   </label>
                               <textarea id="summernote">Ullam voluptates iusUllam voluptates iusUllam voluptates iusUllam 
                                        voluptates iusUllam voluptates iusUllam voluptates iusUllam voluptates iusUllam voluptates iusUllam voluptates ius</textarea>
                           </div>
                        </div>
                        <div class="col-md-12">
							<div class="form-group">
								  <label class="col-form-label">Purchase Price </label>
							     <input type="text" id="" class="form-control" name="" value="866.00">
						    </div>
						</div>
						<div class="col-md-12">
							<div class="form-group">
								 <label class="col-form-label">Sale Price</label>
							     <input type="text" id="" class="form-control" name="" value="100.00">
							</div>
						</div>
						<div class="col-md-12">
							<div class="form-group">
							  <label class="col-form-label">SKU</label>
							    <div class="chat-search">
								 <div class="input-group">
									<input type="text" id="" class="form-control" value="Nulla earum odio vol" >
								 </div>
							  </div>
						    </div>
						</div>
					    <div class="col-md-6">
							<div class="form-group row">
								  <label class="col-lg-12 col-form-label">Tyre Size</label>
								   <div class="col-lg-12">
									 <input type="text" id="" class="form-control" name="" value="Qui voluptate incidu">
								  </div>
						    </div>
						</div>
						<div class="col-md-6">
							<div class="form-group row">
							  <label class="col-lg-12 col-form-label">Quantity </label>
							   <div class="col-lg-12">
								 <input type="text" id="" class="form-control" name="" value="10">
							  </div>
						    </div>
						</div>
						<div class="col-md-6">
							<div class="form-group row">
							  <label class="col-lg-12 col-form-label">Location</label>
							    <div class="col-lg-12">
								 <input type="text" id="" class="form-control" name="" value="Voluptas vel nihil d">
							    </div>
						    </div>
						</div>
						<div class="col-lg-6 ">
							<div class="form-group">
							    <label class="col-form-label">Compatible vehicle</label>
							    <select name="status" id="status" class="my-select form-control">
                                    <option  data-display="Select a category" >Select a Compatible vehicle </option>
						...
						<div class="col-md-6">
							<div class="form-group row">
							  <label class="col-lg-12 col-form-label"> Model Year </label>
							   <div class="col-lg-12">
								 <input type="text" id="" class="form-control" name="" value="2000">
							  </div>
						    </div>
						</div>
						<div class="col-xl-6">
			...
			<!--<div class="card mb-4">-->
   <!--             <div class="card-body">-->
			<!--		<h4 class="cardTitle"> Edit Seller </h4>-->
   <!--                 <div class="row">-->
			<!--			<div class="col-md-6">-->
			<!--				<div class="form-group row">-->
			<!--				  <label class="col-lg-12 col-form-label">Interior Color</label>-->
			<!--				   <div class="col-lg-12">-->
			<!--					 <input type="text" id="" class="form-control" name="" value="Black">-->
			<!--				  </div>-->
			<!--			    </div>-->
			<!--			</div>-->
			<!--			<div class="col-md-6">-->
