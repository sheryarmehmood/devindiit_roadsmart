...
<div class="content container-fluid add-product-page">
	...
	<form method="POST" id="product_form" name="product_form" enctype="multipart/form-data" action="{{route('admin.saveProduct')}}">
		@csrf
		<div class="row">
			<div class="col-md-12">
				<div class="card mb-4">
						...
						<div class="row">
							<div class="col-12">
								<div class="form-group">
									...
									<input type="text" id="" class="form-control" name="product_name" value="">
								</div>
							</div>
							<div class="col-12">
								<div class="form-group">
							...
							<div class="col-md-6">
								<div class="form-group row">
									...
									<div class="col-lg-12">
										<input type="text" id="purchase_price" class="form-control" name="purchase_price" value="">
									</div>
								</div>
							</div>
							<div class="col-md-6">
							...
							<div class="col-md-6">
								<div class="form-group row">
									...
									<div class="col-lg-12">
										<input type="text" id="SKU" class="form-control" name="SKU" value="">
									</div>
								</div>
							</div>
							<div class="col-md-6">
