...
@section('title', 'Completed payment')
@section('head')
<style>
...
@section('content')
   <div class="content container-fluid addorder">
        <div class="page-header">
                <div class="row">
                    <div class="col">
                       <h3 class="page-title d-flex align-items-center">Completed Payment</h3>
                    ...
                    <div class="col text-right">
                      <div class="actionMore d-flex align-items-center justify-content-end">
                          <a href="{{route('admin.payments')}}" class="btn btn-primary mr-2">Back</a>
                      </div>
                    </div>
                </div>
          </div>
                                       ...
                                       <tr>
                                        ...
                                        <tr>
                                         ...
                                         <tr>
                                            <th>Type</th>
                                            <td class="text-center "> </td>
                                            <td class="text-right pr-0" >Product</td>
                                        </tr>
                                        <tr>
                                            <th>Price</th>
                                            <td class="text-center "> </td>
                                            <td class="text-right pr-0">$500</td>
                                        </tr>
                                        ...
                                        <tr>
                                            <th>Status</th>
                                            <td class="text-center "> </td>
                                            <td class="text-right pr-0" ><label class="badge badge-success">Completed</label>
