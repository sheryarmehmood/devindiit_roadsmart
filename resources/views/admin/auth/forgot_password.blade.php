    ...
    <div class="login-page">
        <div class="login-body container">
            <div class="loginbox">
                ...
                <form  name="forget_password" method="POST"  action="{{ route($passwordEmailRoute) }}">
                         @csrf
                         @if (session('status'))
                ...
                <div class="text-left dont-have mt-3">Remember your password? <a href="{{route('admin.login')}}">Login</a></div>
            </div>
        </div>
    </div>
</div>
