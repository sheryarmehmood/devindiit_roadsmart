            ...
            <div class="col-xl-6">
                              ...
                              <div class="col-lg-12">
                                  ...
                                  <div class="inline field">
                                     <select name="Vehicles" multiple="" class="label ui selection fluid dropdown">
                                       ...
                                       <option value="1" selected>Hundai Verna</option>
                              ...
                              <div class="col-lg-12">
                                  ...
                                  <div class="inline field">
                                     <select name="skills" multiple="" class="label ui selection fluid dropdown">
                                       ...
                                       <option value="3" selected>Pad Replacement</option>
                              ...
                              <div class="col-lg-12">
                                  ...
                                  <div class="inline field">
                                     <select name="skills" multiple="" class="label ui selection fluid dropdown">
                                       ...
                                       <option value="4"selected>Shoe Replacement</option>
                                       <option value="5"selected>Clean and Adjust </option>
                                       <option value="6">Other</option>
                                     </select>
                                   </div>
                              </div>
                        ...
                        <div class="col-xl-6">
                           <div class="form-group row">
                              ...
                              <div class="col-lg-12">
                                 <input type="text" class="form-control" value="$124">
                              </div>
                           </div>
                        </div>
                        <div class="col-xl-6">
