                        ...
                        <div class="dropdown-menu dropdown-menu-right notifications">
                            <div class="noti-content">
                                <ul class="notification-list">
                                    ...
                                    <li class="notification-message">
                                        <a href="javascript:void(0)">Create Report</a>
                                    </li>
                                    <li class="notification-message">
            ...
            <div class="col-md-8">
                <div class="card mb-4 overflow-visible"> 
                   <div class="card-body">
						...
						<h3 class="mb-0 text-danger">Request Id : <span class="text-muted"><a href="#">#1002-F2</a></span> <span class="text-primary ml-3"><!---a href="javascript: void(0)" data-toggle="modal" data-target="#vinfo-popup">2018 Toyota Hilux</a--</span></h3>
						</div---->
											...
											<label class="col-form-label">Requested Services</label>
											  <select name="Vehicles" multiple="" class="label ui selection fluid dropdown">
											   <option value="">Select Requested Services</option>
											    <option value="5">Brake Replacement</option>
												 <option value="4">Electrical Diagnosis</option>
                   ...
                   <div class="card-body">
                      <div class="d-block">
                         ...
                         <div class="row">
    						<div class="col-lg-12">
    							<div class="form-group">
    								<textarea type="text" class="form-control h_100" name="" value=""></textarea>
    							</div>
    						</div>
                         </div>
                   </div>
    				...
    				<div class="card-body p-2 py-3 px-4">
						...
						<div class="form-group">
											  <select name="Vehicles" class="my-select w-100">
											   ...
											   <option value="2">#4PDFDFY56CH</option>
                ...
                <div class="card card-table mb-4">
    				<div class="card-body p-2 py-3 px-4">
						 <div class="d-flex justify-content-between align-items-center">
							 ...
							 <div>
								<a data-toggle="modal" data-target="#create-report-popup" href="javascript: void(0);">Create Report</a>
							</div>
						  </div>
							<div class="mt-3">
								<ul  class="rightsidelistitems ">
									<li><a href="#">Assessment Report </a> <span class="badge badge-success">Sent</span></li>
									<li><a href="#">Inspection Report </a><span class="badge badge-warning">Draft</span></li>
									<li><a href="#">Repairs Report </a><span class="badge badge-warning">Draft</span></li>
								</ul>
							</div>
    				</div>
                </div>  
					    ...
					    <div class="col-md-12 mb-3">
                           <div class="form-group">
                              ...
                              <select class="my-select form-control">
									...
									<option value="840i Gran Couple ">840i Gran Couple </option>
							  </select>
                           </div>
                        </div>
						...
						<div class="col-md-12 mb-3">
                           <div class="form-group">
                              ...
                              <select multiple="" class="label ui selection fluid dropdown">
									...
									<option value="1">Oil Leak </option>
									<option value="2">Ball Joint </option>
