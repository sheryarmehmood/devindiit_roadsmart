                            ...
                            <div class="viewBox container px-0 mt-3">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="checkbox">
                                            <label class="mb-0">
                                                <input type="checkbox" name="checkbox" class="mr-2" checked> Customer
                                                agreed to receive marketing emails.
                                            </label>
                                            ...
                                            <label class="mb-0 text-muted">
                                                <input type="checkbox" name="checkbox" class="mr-2" checked> Customer
                                                agreed to receive SMS marketing text messages.
                                            ...
                                            <label class="mb-3 text-muted">
                                                You should ask your customers for permission before you subscribe them to
                                                your marketing emails or SMS.
                                            </label>
                    ...
                    <div class="card-table mb-0">
                        <div class="card-body addorder p-0imp">
                            ...
                            <div class="chat-search d-flex justify-content-between align-items-center">
                                ...
                                <a class="btn btn-primary filter-btn ml-2" href="javascript: void(0);"
                                    id="filter_search">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="" class="form-control" name=""
                                                value="" placeholder="Apartment, suite, etc.">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="form-group">
                                            ...
                                            <input type="phone" id="" class="form-control" name=""
                                                value="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <small class="form-text text-muted mt-2 float-left w-100">This customer will
                                                receive notifications in this language..</small>
