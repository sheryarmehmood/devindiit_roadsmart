...
@section('content')
   <div class="content container-fluid addorder">
      <div class="page-header">
         <div class="row">
            <div class="col">  
               <h3 class="page-title">#DR3 Updated by Davy Duba Today at 5:20 pm</h3>
            </div>
            <div class="col text-right">
              <div class="actionMore d-flex align-items-center justify-content-end">
                  ...
                  <a href="javascript:void(0)" class="ediio ml-3"> Duplicate </a>
                  <a href="javascript:void(0)" class="ediio ml-3"> Share </a>
                  <a href="{{route('seller.request_draft')}}" class="btn btn-primary ml-3 mr-2">Back</a>
               ...
               <div class="card-body p-2 py-3 px-4">
                  <div class="d-flex justify-content-between align-items-center">
                     <h3 class="mb-0">Request</h3>
                      <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a class="ml-3" data-toggle="modal" data-target="#addcustom-popup" href="javascript: void(0);">Add Product</a>
                     </div>
                  </div>
                  <div class="chat-search d-flex justify-content-between align-items-center">
                     <div class="input-group">
                        ...
                        <input type="text" class="form-control" data-toggle="modal" data-target="#addorder-popup" id="launch-modal" placeholder="Search Services">
                     </div>
                        ...
                        <div id="accordion">
                            <div class="Request_card">
                                ...
                                <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                                    <div class="Requestadd_div">
                                        <a class="btn btn-primary" href="javascript:void(0)" data-toggle="modal" data-target="#addrequest-popup">Add</a>
                                    </div>
               ...
               <div class="card-body p-2 py-3 px-4">
                  ...
                  <div class="payemntboxhide">
                     <div class="text-right d-flex justify-content-end">
                        ...
                        <a class="btn btn-primary" href="javascript:void(0)">Create Request</a>
                     </div>
                  </div>
