        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        <li class="{{ (\Request::route()->getName() =='seller.store_details') ?  'active' : '' }}">
                            <a href="{{route('seller.store_details')}}"><i class="fas fa-store"></i> <span>Store Details</span></a>
                        </li>
                        <li>
                            <a href="javascript:void(0)"><i class="fas fa-clipboard-list"></i> <span>Plan</span></a>
                        </li>
                        <li class="{{ (\Request::route()->getName() =='seller.user_permissions') ?  'active' : '' }}">
                            <a href="{{route('seller.user_permissions')}}"><i class="fas fa-user"></i> <span>Users & Permissions</span></a>
                        </li>
                             <li class="<?= ($activePage == 'bank-details') ? 'active':''; ?>"><a href="bank-details.php"><i class="fas fa-wallet"></i> <span>Payments</span></a></li>
                             <li><a href="javascript:void(0)"><i class="fas fa-shipping-fast"></i> <span>Shipping & Delivery</span></a></li>
                             <li class="<?= ($activePage == 'locations') ? 'active':''; ?>"><a href="locations.php"><i class="fas fa-map-marker-alt"></i> <span>Locations</span></a></li>
                             <li><a href="sales-channel.php" class="<?= ($activePage == 'bank-details') ? 'active':''; ?>"><i class="fas fa-shopping-bag"></i> <span>Sales Channels</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>  
