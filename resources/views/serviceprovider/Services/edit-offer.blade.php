        ...
        <div class="row">
            ...
            <div class="col-md-8">
                         ...
                         <div class="row">
    						...
    						<div class="col-xl-12 ml-auto">
                                <div class="form-group ">
								  ...
								  <input type="text" id="" placeholder="" class="form-control" name="" value="Rotor Replacement">
							    </div>
                            </div>
               ...
               <div class="card-body">
					...
					<div class="checkbox">
                                    <label class="mb-3">
                                       <input type="checkbox" name="pricepackagecheck" id="price_package_check"  checked> Offer as a package
                                    </label>
                    </div> 
                    ...
                    <div class="row">
							<div class="col-md-6">
								<div class="form-group ">
								  ...
								  <input type="text" id="" placeholder="K 0.00" class="form-control" name="" value="K 500.00" >
							    </div>
							</div>
							<div class="col-md-6">
								<div class="form-group ">
								  <label class="col-form-label">Compare at price</label>
								  <input type="text" id="" placeholder="K 0.00" class="form-control" name="" value="K 620.00">
							    </div>
							</div>
							<div class="col-md-12">
								<div class="checkbox">
                                    <label class="mb-3">
                                       <input type="checkbox" name="checkbox" checked  > Charge tax on this offer. 
                                    </label>
                                 </div> 
							</div>
			...
			<div class="card mb-4">
               <div class="card-body">
					...
					<div class="text-right mt-4 mb-4">
                        <button type="submit" class="btn btn-primary  product-save-btn">Update Offer</button>
