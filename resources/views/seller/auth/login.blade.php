         ...
         <div class="loginbox">
            <div class="login-right-wrap">
               ...
               <!-- @if ($errors->has('password'))
                ...
                @endif -->
              <form method="POST" action="{{ route('seller.loginseller') }}" name="signIn">
                  @csrf
                  ...
                  <div class="form-group mb-4">
                     <div class="">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="remember" id="remember" <?php if(isset($_COOKIE['seller_email'])){echo 'checked';}?>>
               ...
               <div class="text-left forgotpass mt-3"><a href="{{ route('seller.password.request') }}">Forgot Password?</a></div>
            </div>
         </div>
      </div>
   </div>
